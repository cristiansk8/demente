	...
	protected function get_notification() {
		return new Yoast_Notification(
			sprintf(
				...
				esc_html__(
					'The %5$sText link counter%6$s feature (introduced in %1$s %2$s) is currently disabled. For this feature to work %1$s needs to create a table in your database. We were unable to create this table automatically.
