	...
	protected function get_notification() {
		return new Yoast_Notification(
			sprintf(
				...
				esc_html__(
					'The %7$sText link counter%8$s feature (introduced in %1$s %2$s) is currently disabled. For this feature to work %1$s requires at least PHP version %3$s. We have detected PHP version %4$s on this website.
